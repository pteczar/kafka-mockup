...
public class ConsumerDemoWithGroups {
    ...
    public static void main(String[] args) {
        ...
        String groupId = "my-fifth-application"; // start three consumers within this group and it will balance and redolence itself
        ...
        consumer.subscribe(Collections.singleton(topic)); // for more topics use arrays consumer.subscribe(Arrays.asList("first_topic", "second_topic, third etc..))
